...
이렇게 크롤링을 통해 SPA와 iframe 문제를 해결하고, 사용자가 입력한 키워드를 보다 더 넓은 범위로 대응할 수 있게 되었습니다.<br />
...
### 3-4. 크롤링으로 가져온 검색 결과를 한 번 더 검색할 순 없을까?
...
하지만 문제는 크롤링의 속도였습니다. Promise.allSetteld()를 5개씩 묶어 보내고 결과를 먼저 보여줌으로써 느린 크롤링의 속도를 UX적으로 개선했는데, 다시 추가 검색을 통해 느린 속도를 경험한다면 사용자 이탈률이 높아질 것이라고 생각했습니다.<br /><br />
